...
describe BankAccount do
    subject { BankAccount.new('Franco Pueyo')}
    ...
    it "should initialize with a name" do
        bank_account = BankAccount.new('Franco Pueyo')
        bank_account.name.must_equal 'Franco Pueyo'
    end
    ...
    describe "#deposit" do
        before do
            @bank_account = BankAccount.new("Franco")
        end
